...
function MBH.OptionFrame:CreateOptionFrame()
    ...
    self.RandomTargetCheckButton = MBH_CreateCheckButton(self.HealingContainer, MBH_RANDOMTARGET,
        MoronBoxHeal_Options.AutoHeal.Random_Target, -15)
    ...
    self.HealTargetSlider:SetScript("OnShow", function()
        MBH_InitializeSlider(self.HealTargetSlider, MBH_HEALTARGETNUMBER,
            MoronBoxHeal_Options.AutoHeal.Heal_Target_Number, 1, 5, 1)
    end)
    ...
    self.OverHealHealSlider:SetScript("OnShow", function()
        MBH_InitializeSlider(self.OverHealHealSlider, MBH_ALLOWEDOVERHEAL,
            MoronBoxHeal_Options.AutoHeal.Allowed_Overheal_Percentage)
    end)

    self.SmartHealCheckButton = MBH_CreateCheckButton(self.HealingContainer, MBH_SMARTHEAL,
        MoronBoxHeal_Options.AutoHeal.Smart_Heal, -15)
    ...
    self.ExtendedRangeCheckButton = MBH_CreateCheckButton(self.ExtendedRangeContainer, MBH_EXTENDEDRANGE,
        MoronBoxHeal_Options.ExtendedRange.Enable, -15)
    ...
    self.ExtendedRangeFrequencySlider:SetScript("OnShow", function()
        MBH_InitializeSlider(self.ExtendedRangeFrequencySlider, MBH_EXTENDEDRANGEFREQUENCY,
            MoronBoxHeal_Options.ExtendedRange.Frequency, 1, 5, 0.25)
    end)
    ...
    self.LineOfSightCheckButton = MBH_CreateCheckButton(self.LineOfSightContainer, MBH_LINEOFSIGHT,
        MoronBoxHeal_Options.LineOfSight.Enable, -15)
    ...
    self.LineOfSightFrequencySlider:SetScript("OnShow", function()
        MBH_InitializeSlider(self.LineOfSightFrequencySlider, MBH_LINEOFSIGHTFREQUENCY,
            MoronBoxHeal_Options.LineOfSight.TimeOut, 0.5, 5, 0.25)
    end)
    ...
    self.ManaProtectionCheckButton = MBH_CreateCheckButton(self.AdvancedOptionsContainer, MBH_MANAPROTECTION,
        MoronBoxHeal_Options.AdvancedOptions.Mana_Protection, -15)
    ...
    self.IdleProtectionCheckButton = MBH_CreateCheckButton(self.AdvancedOptionsContainer, MBH_IDLEPROTECTIONENABLE,
        MoronBoxHeal_Options.AdvancedOptions.LagPrevention.Enabled, -15)
    ...
    self.IdleProtectionFrequencySlider = MBH_CreateSlider(self.AdvancedOptionsContainer, "IdleProtectionFrequencySlider",
        220)
    ...
    self.IdleProtectionFrequencySlider:SetScript("OnShow", function()
        MBH_InitializeSlider(self.IdleProtectionFrequencySlider, MBH_IDLEPROTECTIONFREQUENCY,
            MoronBoxHeal_Options.AdvancedOptions.LagPrevention.Frequency, 1, 5, 0.25)
    end)
end
...
function MBH.ProtectionFrame:CreateProtectionFrame()
    ...
    if (MBH.Session.PlayerClass == MBH_CLASS_PRIEST) then
        ...
        self.FlashHealThresholdSlider:SetScript("OnShow", function()
            MBH_InitializeSlider(self.FlashHealThresholdSlider, MBH_FLASHHEALPROTECTIONTHRESHOLD,
                MoronBoxHeal_Options.ManaProtectionValues.Priest.Flash_Heal_Threshold)
        end)

        self.FlashHealLAR = MBH_CreateEditBox(self.InnerContainer, MBH_LOWEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Flash_Heal_LAR)
        self.FlashHealLAR:SetPoint("CENTER", self.FlashHealThresholdSlider, "CENTER", 50, -50)

        self.FlashHealHAR = MBH_CreateEditBox(self.InnerContainer, MBH_HIGHEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Flash_Heal_HAR)
        self.FlashHealHAR:SetPoint("CENTER", self.FlashHealLAR, "CENTER", 0, -50)

        self.FlashHealCheckButton = MBH_CreateCheckButton(self.InnerContainer, MNH_ACTIVESWITCH,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Flash_Heal_Switch)
        ...
        self.HealThresholdSlider:SetScript("OnShow", function()
            MBH_InitializeSlider(self.HealThresholdSlider, MBH_HEALPROTECTIONTHRESHOLD,
                MoronBoxHeal_Options.ManaProtectionValues.Priest.Heal_Threshold)
        end)

        self.HealLAR = MBH_CreateEditBox(self.InnerContainer, MBH_LOWEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Heal_LAR)
        self.HealLAR:SetPoint("CENTER", self.HealThresholdSlider, "CENTER", 50, -50)

        self.HealHAR = MBH_CreateEditBox(self.InnerContainer, MBH_HIGHEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Heal_HAR)
        self.HealHAR:SetPoint("CENTER", self.HealLAR, "CENTER", 0, -50)

        self.HealCheckButton = MBH_CreateCheckButton(self.InnerContainer, MNH_ACTIVESWITCH,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Heal_Switch)
        ...
        self.GreaterHealThresholdSlider:SetScript("OnShow", function()
            MBH_InitializeSlider(self.GreaterHealThresholdSlider, MBH_GREATERHEALPROTECTIONTHRESHOLD,
                MoronBoxHeal_Options.ManaProtectionValues.Priest.Greater_Heal_Threshold)
        end)

        self.GreaterHealLAR = MBH_CreateEditBox(self.InnerContainer, MBH_LOWEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Greater_Heal_LAR)
        self.GreaterHealLAR:SetPoint("CENTER", self.GreaterHealThresholdSlider, "CENTER", 50, -50)

        self.GreaterHealHAR = MBH_CreateEditBox(self.InnerContainer, MBH_HIGHEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Greater_Heal_HAR)
        self.GreaterHealHAR:SetPoint("CENTER", self.GreaterHealLAR, "CENTER", 0, -50)

        self.GreaterHealCheckButton = MBH_CreateCheckButton(self.InnerContainer, MNH_ACTIVESWITCH,
            MoronBoxHeal_Options.ManaProtectionValues.Priest.Greater_Heal_Switch)
    ...
    elseif (MBH.Session.PlayerClass == MBH_CLASS_SHAMAN) then
        ...
        self.ChainHealThresholdSlider:SetScript("OnShow", function()
            MBH_InitializeSlider(self.ChainHealThresholdSlider, MBH_CHAINHEALPROTECTIONTHRESHOLD,
                MoronBoxHeal_Options.ManaProtectionValues.Shaman.Chain_Heal_Threshold)
        end)

        self.ChainHealLAR = MBH_CreateEditBox(self.InnerContainer, MBH_LOWEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Shaman.Chain_Heal_LAR)
        self.ChainHealLAR:SetPoint("CENTER", self.ChainHealThresholdSlider, "CENTER", 50, -50)

        self.ChainHealHAR = MBH_CreateEditBox(self.InnerContainer, MBH_HIGHEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Shaman.Chain_Heal_HAR)
        self.ChainHealHAR:SetPoint("CENTER", self.ChainHealLAR, "CENTER", 0, -50)

        self.ChainHealCheckButton = MBH_CreateCheckButton(self.InnerContainer, MNH_ACTIVESWITCH,
            MoronBoxHeal_Options.ManaProtectionValues.Shaman.Chain_Heal_Switch)
        ...
        self.LesserHealingWaveThresholdSlider = MBH_CreateSlider(self.InnerContainer, "LesserHealingWaveThresholdSlider",
            180)
        ...
        self.LesserHealingWaveThresholdSlider:SetScript("OnShow", function()
            MBH_InitializeSlider(self.LesserHealingWaveThresholdSlider, MBH_LESSERHEALINGWAVEPROTECTIONTHRESHOLD,
                MoronBoxHeal_Options.ManaProtectionValues.Shaman.Lesser_Healing_Wave_Threshold)
        end)

        self.LesserHealingWaveLAR = MBH_CreateEditBox(self.InnerContainer, MBH_LOWEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Shaman.Lesser_Healing_Wave_LAR)
        self.LesserHealingWaveLAR:SetPoint("CENTER", self.LesserHealingWaveThresholdSlider, "CENTER", 50, -50)

        self.LesserHealingWaveHAR = MBH_CreateEditBox(self.InnerContainer, MBH_HIGHEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Shaman.Lesser_Healing_Wave_HAR)
        self.LesserHealingWaveHAR:SetPoint("CENTER", self.LesserHealingWaveLAR, "CENTER", 0, -50)

        self.LesserHealingWaveCheckButton = MBH_CreateCheckButton(self.InnerContainer, MNH_ACTIVESWITCH,
            MoronBoxHeal_Options.ManaProtectionValues.Shaman.Lesser_Healing_Wave_Switch)
    ...
    elseif (MBH.Session.PlayerClass == MBH_CLASS_PALADIN) then
        ...
        self.HolyLightThresholdSlider:SetScript("OnShow", function()
            MBH_InitializeSlider(self.HolyLightThresholdSlider, MBH_HOLYLIGHTPROTECTIONTHRESHOLD,
                MoronBoxHeal_Options.ManaProtectionValues.Paladin.Holy_Light_Threshold)
        end)

        self.HolyLightLAR = MBH_CreateEditBox(self.InnerContainer, MBH_LOWEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Paladin.Holy_Light_LAR)
        self.HolyLightLAR:SetPoint("CENTER", self.HolyLightThresholdSlider, "CENTER", 50, -50)

        self.HolyLightHAR = MBH_CreateEditBox(self.InnerContainer, MBH_HIGHEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Paladin.Holy_Light_HAR)
        self.HolyLightHAR:SetPoint("CENTER", self.HolyLightLAR, "CENTER", 0, -50)

        self.HolyLightCheckButton = MBH_CreateCheckButton(self.InnerContainer, MNH_ACTIVESWITCH,
            MoronBoxHeal_Options.ManaProtectionValues.Paladin.Holy_Light_Switch)
    ...
    elseif (MBH.Session.PlayerClass == MBH_CLASS_DRUID) then
        ...
        self.RegrowthThresholdSlider:SetScript("OnShow", function()
            MBH_InitializeSlider(self.RegrowthThresholdSlider, MBH_REGROWTHPROTECTIONTHRESHOLD,
                MoronBoxHeal_Options.ManaProtectionValues.Druid.Regrowth_Threshold)
        end)

        self.RegrowthLAR = MBH_CreateEditBox(self.InnerContainer, MBH_LOWEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Druid.Regrowth_LAR)
        self.RegrowthLAR:SetPoint("CENTER", self.RegrowthThresholdSlider, "CENTER", 50, -50)

        self.RegrowthHAR = MBH_CreateEditBox(self.InnerContainer, MBH_HIGHEST_RANK,
            MoronBoxHeal_Options.ManaProtectionValues.Druid.Regrowth_HAR)
        self.RegrowthHAR:SetPoint("CENTER", self.RegrowthLAR, "CENTER", 0, -50)

        self.RegrowthCheckButton = MBH_CreateCheckButton(self.InnerContainer, MNH_ACTIVESWITCH,
            MoronBoxHeal_Options.ManaProtectionValues.Druid.Regrowth_Switch)
        ...
        self.OnlyRank3CheckButton = MBH_CreateCheckButton(self.InnerContainer, MNH_DRUIDLOWRANK,
            MoronBoxHeal_Options.ManaProtectionValues.Druid.Only_Rank_3)
