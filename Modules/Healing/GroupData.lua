...
function MBH_UpdateData()
    ...
    if MBH.Session.Group[1] == 3 or MBH.Session.Group[1] == 2 then
        for i = 1, MBH.Session.Group[2] do
            ...
            MBH.GroupData[MBH.Session.I].HealthDeficite = UnitHealthMax(MBH.GroupData[MBH.Session.I].UnitID) -
                UnitHealth(MBH.GroupData[MBH.Session.I].UnitID)
            MBH.GroupData[MBH.Session.I].UnitRange = CheckInteractDistance(MBH.GroupData[MBH.Session.I].UnitID, 4)
            MBH.GroupData[MBH.Session.I].Visible = UnitIsVisible(MBH.GroupData[MBH.Session.I].UnitID) and
                UnitIsConnected(MBH.GroupData[MBH.Session.I].UnitID) and
                not UnitIsGhost(MBH.GroupData[MBH.Session.I].UnitID) and
                not UnitIsDead(MBH.GroupData[MBH.Session.I].UnitID) and
                not UnitIsEnemy(MBH.GroupData[MBH.Session.I].UnitID, "player") and
                not UnitCanAttack("player", MBH.GroupData[MBH.Session.I].UnitID)
            ...
            if MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].LOS then
                if MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].LOS > 0 then
                    MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].LOS = MBH.Track[MBH.GroupData[MBH.Session.I].UnitID]
                        .LOS - MBH.Session.Elapsed
                else
            ...
            if MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].HealTime then
                if MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].HealTime > 0 then
                    MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].HealTime = MBH.Track
                        [MBH.GroupData[MBH.Session.I].UnitID].HealTime - MBH.Session.Elapsed
                    MBH.GroupData[MBH.Session.I].HealValue = (UnitHealth(MBH.GroupData[MBH.Session.I].UnitID) + MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].Heal) /
                        UnitHealthMax(MBH.GroupData[MBH.Session.I].UnitID)
    ...
    if MBH.Session.Group[1] == 2 or MBH.Session.Group[1] == 1 then -- Add player
        ...
        if MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].LOS then
            if MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].LOS > 0 then
                MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].LOS = MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].LOS -
                    MBH.Session.Elapsed
            else
                MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].LOS = nil
            end
        ...
        if MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].HealTime then
            if MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].HealTime > 0 then
                MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].HealTime = MBH.Track[MBH.GroupData[MBH.Session.I].UnitID]
                    .HealTime - MBH.Session.Elapsed
                MBH.GroupData[MBH.Session.I].HealValue = (UnitHealth(MBH.GroupData[MBH.Session.I].UnitID) + MBH.Track[MBH.GroupData[MBH.Session.I].UnitID].Heal) /
                    UnitHealthMax(MBH.GroupData[MBH.Session.I].UnitID)
                if MBH.GroupData[MBH.Session.I].HealValue > 1 then
                    MBH.GroupData[MBH.Session.I].HealValue = 1
